...
class HorizontalLine(QtWidgets.QWidget):
    ...
    def _initLine(self):
        ...
        self.line.setObjectName(self.objectName)
...
'''class pushButtonDrives(QtWidgets.QWidget):
    def __init__(self, objectName="pushButtonDrives", stretchFactorH=0,
                 stretchFactorV=0,  wmin=32, hmin=32, wmax=32,
                 hmax=32, wbase=32,  hbase=32,  wicon=32,  hicon=32,
                 flat=True, text="", parent=None):
        super().__init__()
        self.objectName = objectName
        ...
        self.text = text
        self.parent = None
        self._initComboBoxDrives()

    def _initComboBoxDrives(self):
        ...
        self.pushButton.setMinimumSize(QtCore.QSize(self.wmin, self.hmin))
        self.pushButton.setMaximumSize(QtCore.QSize(self.wmax, self.hmax))
        self.pushButton.setBaseSize(QtCore.QSize(self.wbase, self.hbase))
        self.pushButton.setFlat(self.flat)
        self.pushButton.setObjectName(self.objectName)
        self.pushButton.setText(self.text)'''
...
'''class HLayout(QtWidgets.QWidget):
    ...
    def _initHLayout(self):
        ...
        self.testLayout.setSizeConstraint(
...
'''class DrivesToolBar(QtWidgets.QWidget):
    def __init__(self, color):
        super().__init__()
        self.color = color
        #self.parent = parent
    ...
    def _makeToolBar(self):
        self.testLayout.addWidget(Color("red"))
       # horizontalSpacerLeftDrivesLeft = QtWidgets.QSpacerItem(
        #    self.wspacer, self.hspacer, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        #self.testLayout.addWidget(horizontalSpacerLeftDrivesLeft)
        self.labelLeftDiskVolumeSize = QtWidgets.QLabel(self)
        self.labelLeftDiskVolumeSize.setObjectName("labelLeftDiskVolumeSize")
        self.labelLeftDiskVolumeSize.setText("396gb")
        self.testLayout.addWidget(self.labelLeftDiskVolumeSize)
        
        #horizontalSpacerLeftDrivesRight = QtWidgets.QSpacerItem(self.wspacer, self.hspacer, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        #self.testLayout.addWidget(horizontalSpacerLeftDrivesRight)
        self.testLayout.addWidget(Color("blue"))
        self.testLayout.addWidget(Color("green"))
        self.testLayout.addWidget(Color("magenta"))
        self.testLayout.addWidget(Color("cyan"))
        self.testLayout.addWidget(Color("black"))'''


class HLayout(QtWidgets.QWidget):

    def __init__(self, leftMargin=-1, topMargin=-1, rightMargin=-1,
                 bottomMargin=0, layoutSpacing=7,  stretchFactorH=0,
                 stretchFactorV=0,  wmin=48,  hmin=32,  wmax=48,
                 hmax=32, wbase=48, hbase=32, wicon=16,  hicon=16,
                 wspacer=40,  hspacer=20, parent=None):
    ...
    def _initHLayout(self):
        ...
        self.hlayout.setSizeConstraint(
            QtWidgets.QLayout.SetDefaultConstraint)
        self.hlayout.setContentsMargins(self.leftMargin,
                                        self.topMargin, self.rightMargin, self.bottomMargin)
        self.hlayout.setSpacing(self.layoutSpacing)
...
class ComboBoxDrives(QtWidgets.QComboBox):
    ...
    def _initComboBoxDrives(self):        
        self.setObjectName("comboBoxDrives")
...
class DriveButton(QtWidgets.QPushButton):
    ...
    def __init__(self, objectName="", text="",
        ...
        self.setMinimumSize(QtCore.QSize(wmin, hmin))
        self.setMaximumSize(QtCore.QSize(wmax, hmax))
        self.setBaseSize(QtCore.QSize(wbase, hbase))
        icon = QtGui.QIcon()
        full_path = os.path.join(path, iconName)
        icon.addPixmap(QtGui.QPixmap(full_path),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(full_path),
                       QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.setIcon(icon)
        self.setIconSize(QtCore.QSize(wicon, hicon))
        self.setFlat(flat)
        self.setText(text)
...
class DrivesButtonBar(QtWidgets.QWidget):
    ...
    def _initDrivesButtonBar(self):       
        ...
        hlayout.setSizeConstraint(
                QtWidgets.QLayout.SetDefaultConstraint)        
        
        hlayout.setContentsMargins(self.leftMargin, self.topMargin, 
                                   self.rightMargin, self.bottomMargin)  
        hlayout.setSpacing(self.layoutSpacing)
        self.btn1 = Color("red")
        ...
        self.button1 = DriveButton(objectName="pushButtonDrive1",  text="C",
                                   path=path_full, iconName=iname1)
        self.button2 = DriveButton(objectName="pushButtonDrive2", text="//",
...
class DrivesList(QtWidgets.QWidget):
    def __init__(self, objectName="horizontalLayoutDrivesList",
                 leftMargin=-1, topMargin=-1, rightMargin=-1,
                 bottomMargin=0, layoutSpacing=7,
                 wspacer=40, hspacer=20, parent=None):
        super().__init__(parent = parent)
        self.objectName = objectName
        self.leftMargin = leftMargin
        ...
        self.wspacer = wspacer
        self.hspacer = hspacer        
        self._initDrivesList()

    def _initDrivesList(self):
        self.horizontalLayoutDrivesList = QtWidgets.QHBoxLayout()
        self.horizontalLayoutDrivesList.setSizeConstraint(
            QtWidgets.QLayout.SetDefaultConstraint)
        self.horizontalLayoutDrivesList.setContentsMargins(self.leftMargin,
                                                           self.topMargin, self.rightMargin, self.bottomMargin)
        self.horizontalLayoutDrivesList.setSpacing(self.layoutSpacing)
        self.horizontalLayoutDrivesList.setObjectName(self.objectName)
        self.comboBoxDrives = Color("yellow")    #ComboBoxDrives()
        self.horizontalLayoutDrivesList.addWidget(self.comboBoxDrives)
        ''' spacerItemDrives = QtWidgets.QSpacerItem(
            self.wspacer, self.hspacer, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayoutDrivesList.addItem(spacerItemDrives)

        self.pushButtonDirectoryHotlist = DriveButton (
            objectName="pushButtonDirectoryHotlist", stretchFactorH=0,
                         stretchFactorV=0,  wmin=32, hmin=32, wmax=32,
                         hmax=32, wbase=32,  hbase=32,  wicon=32,  hicon=32,
                         flat=True, text="*",  parent=self.parent)
        self.horizontalLayoutDrivesList.addWidget(
...
class Window(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.leftDrivesButtonBar = DrivesButtonBar(parent = self.centralWidget)
        self.rightDrivesButtonBar = DrivesButtonBar(parent = self.centralWidget)
        ...
        self.gridLayout.addWidget(self.line, 1, 0, 1, 2)
        #self.leftDrivesList = DrivesList(
                              #objectName="horizontalLayoutLeftDrivesList", 
                              #parent = self.centralWidget) #DrivesToolBar("red")
        #self.rightDrivesList = DrivesList(
                              # objectName="horizontalLayoutRightDrivesList", 
                               #parent = self.centralWidget)   #Dr()ivesToolBar("red")
        self.leftDrivesList = DrivesList(parent = self.centralWidget) #Color("red") 
        self.rightDrivesList = DrivesList(parent = self.centralWidget) #Color("blue")
    ...
    def _createActions(self):
        ...
        self.actionCalculateOccupiedSpace.setObjectName(
            "actionCalculateOccupiedSpace")
        ...
        self.actionSelectAllWithTheSameExtension.setObjectName(
            "actionSelectAllWithTheSameExtension")
        self.actionSelectAllWithTheSameExtension.setText(
            "&Select All with the Same Extension")
        ...
        self.actionSaveSelectionToFile.setObjectName(
            "actionSaveSelectionToFile")
        ...
        self.actionLoadSelectionFromFile.setObjectName(
            "actionLoadSelectionFromFile")
        self.actionLoadSelectionFromFile.setText(
        ...
        self.actionLoadSelectionFromClipboard.setObjectName(
            "actionLoadSelectionFromClipboard")
        self.actionLoadSelectionFromClipboard.setText(
        ...
        self.actionCopyFilenameToClipboard.setObjectName(
            "actionCopyFilenameToClipboard")
        self.actionCopyFilenameToClipboard.setText(
        ...
        self.actionCopyFilenameWithFullPath.setObjectName(
            "actionCopyFilenameWithFullPath")
        self.actionCopyFilenameWithFullPath.setText(
            "&Copy Filename(s) With Full Path")
        ...
        self.actionCopyAllShownColumns.setObjectName(
            "actionCopyAllShownColumns")
        ...
        self.actionViewCurrentSearchInstances.setObjectName(
            "actionViewCurrentSearchInstances")
        self.actionViewCurrentSearchInstances.setText(
            "&View Current Search Instances")
        ...
        self.actionExecuteInternalCommand.setObjectName(
            "actionExecuteInternalCommand")
        self.actionExecuteInternalCommand.setText(
        ...
        self.actionDisconnectNetworkDrive.setObjectName(
            "actionDisconnectNetworkDrive")
        self.actionDisconnectNetworkDrive.setText(
        ...
        self.actionCopyNamesWithUNCPath.setObjectName(
            "actionCopyNamesWithUNCPath")
        ...
        self.actionSwitchToPreviousTab.setObjectName(
            "actionSwitchToPreviousTab")
        ...
        self.actionSaveCurrentTabsToNewFavoriteTabs.setObjectName(
            "actionSaveCurrentTabsToNewFavoriteTabs")
        self.actionSaveCurrentTabsToNewFavoriteTabs.setText(
            "&Save Current Tabs to New Favorite Tabs")
        ...
        self.actionLoadTabsFromFavoriteTabs.setObjectName(
            "actionLoadTabsFromFavoriteTabs")
        self.actionLoadTabsFromFavoriteTabs.setText(
        ...
        self.actionConfigurationOfFolderTabs.setObjectName(
            "actionConfigurationOfFolderTabs")
        self.actionConfigurationOfFolderTabs.setText(
        ...
        self.actionConfigurationOfFavoriteTabs.setObjectName(
            "actionConfigurationOfFavoriteTabs")
        self.actionConfigurationOfFavoriteTabs.setText(
        ...
        self.actionLockedWithDirectoryChangesAllowed.setObjectName(
            "actionLockedWithDirectoryChangesAllowed")
        self.actionLockedWithDirectoryChangesAllowed.setText(
        ...
        self.actionLockedWithDirectoriesOpenedInNewTabs = QtWidgets.QAction(
            self)
        self.actionLockedWithDirectoriesOpenedInNewTabs.setObjectName(
            "actionLockedWithDirectoriesOpenedInNewTabs")
        self.actionLockedWithDirectoriesOpenedInNewTabs.setText(
        ...
        self.actionAllTabsLockedWithDirChangesAllowed.setObjectName(
            "actionAllTabsLockedWithDirChangesAllowed")
        self.actionAllTabsLockedWithDirChangesAllowed.setText(
            "&All Tabs Locked With Dir Changes Allowed")
        self.actionSetAllTabsToLocked.setShortcut("")
        self.actionSetAllTabsToLocked.setStatusTip("")

        self.actionAllTabsLockedWithDirOpenedInNewTabs = QtWidgets.QAction(
            self)
        self.actionAllTabsLockedWithDirOpenedInNewTabs.setObjectName(
            "actionAllTabsLockedWithDirOpenedInNewTabs")
        self.actionAllTabsLockedWithDirOpenedInNewTabs.setText(
        ...
        self.actionResaveOnTheLastFavoriteTabsLoaded.setObjectName(
            "actionResaveOnTheLastFavoriteTabsLoaded")
        self.actionResaveOnTheLastFavoriteTabsLoaded.setText(
            "&Resave on the last Favorite Tabs loaded")
        ...
        self.actionRelopadTheLastFavoriteTabsLoaded.setObjectName(
            "actionRelopadTheLastFavoriteTabsLoaded")
        self.actionRelopadTheLastFavoriteTabsLoaded.setText(
            "&Relopad the last Favorite Tabs loaded")
        self.actionRelopadTheLastFavoriteTabsLoaded.setShortcut("")
        self.actionRelopadTheLastFavoriteTabsLoaded.setStatusTip("")

        self.actionConfigurationOfFavoriteTabs = QtWidgets.QAction(self)
        self.actionConfigurationOfFavoriteTabs.setObjectName(
            "actionConfigurationOfFavoriteTabs2")
        self.actionConfigurationOfFavoriteTabs.setText(
            "&Configuration of Favorite Tabs")
        self.actionConfigurationOfFavoriteTabs.setShortcut("")
        self.actionConfigurationOfFavoriteTabs.setStatusTip("")
        ...
        self.actionShowHiddenSystemFiles.setObjectName(
            "actionShowHiddenSystemFiles")
        ...
        self.actionHorizontalPanelsMode.setObjectName(
            "actionHorizontalPanelsMode")
        ...
        self.actionConfigurationOfDirectoryHotlist.setObjectName(
            "actionConfigurationOfDirectoryHotlist")
        self.actionConfigurationOfDirectoryHotlist.setText(
        ...
        self.actionConfigurationOfFileAssociations.setObjectName(
            "actionConfigurationOfFileAssociations")
        self.actionConfigurationOfFileAssociations.setText(
        ...
        self.actionConfigurationOfArchivers.setObjectName(
            "actionConfigurationOfArchivers")
        self.actionConfigurationOfArchivers.setText(
            "&Configuration of Archivers")
        ...
        self.actionVisitDoubleCommanderWebsite.setObjectName(
            "actionVisitDoubleCommanderWebsite")
        self.actionVisitDoubleCommanderWebsite.setText(
            "&Visit Double Commander Website")
        ...
        icon_refresh.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon_refresh.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_runterm.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_runterm.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_options.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_options.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_briefview.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_briefview.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon_briefview.addPixmap(QtGui.QPixmap(
            "cm_briefview.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_columnsview.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_columnsview.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_thumbnailsview.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_thumbnailsview.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_flatview.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_flatview.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_viewhistoryprev.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_viewhistoryprev.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionTBGotoPreviousEntryInHistory.setIcon(icon_viewhistoryprev)
        self.actionTBGotoPreviousEntryInHistory.setObjectName(
            "actionTBGotoPreviousEntryInHistory")
        self.actionTBGotoPreviousEntryInHistory2 = QtWidgets.QAction(self)
        icon_viewhistorynext = QtGui.QIcon()
        icon_viewhistorynext.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_viewhistorynext.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionTBGotoPreviousEntryInHistory2.setIcon(icon_viewhistorynext)
        self.actionTBGotoPreviousEntryInHistory2.setObjectName(
            "actionTBGotoPreviousEntryInHistory2")
        self.actionTBSelectGroup = QtWidgets.QAction(self)
        icon_markplus = QtGui.QIcon()
        icon_markplus.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_markplus.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_markminus.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_markminus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon_markminus.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_markplus.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_markinvert.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_markinvert.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon_markinvert.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_markplus.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_packfiles.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_packfiles.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_extractfiles.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_extractfiles.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_search.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_search.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_multirename.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_multirename.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_syncdirs.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_syncdirs.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon_copyfullnamestoclip.addPixmap(QtGui.QPixmap(os.path.join(
            path, "cm_copyfullnamestoclip.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionTBCopyFilenameWithFullPath.setIcon(icon_copyfullnamestoclip)
        self.actionTBCopyFilenameWithFullPath.setObjectName(
            "actionTBCopyFilenameWithFullPath")

    def _connectActions(self):
        self.actionCreateSymbolicLink.triggered.connect(
        ...
        self.actionShowFileProperties.triggered.connect(
            self.show_file_properties)
        self.actionEditComment.triggered.connect(self.edit_comment)
        self.actionCalculateOccupiedSpace.triggered.connect(
            self.calculate_occupied_space)
        self.actionCompareByContents.triggered.connect(
            self.compare_by_contents)
        ...
        self.actionCalculateChecksum.triggered.connect(
            self.calculate_checksaum)
        ...
        self.actionSelectAllWithTheSameExtension.triggered.connect(
            self.select_all_with_the_same_extension)
        ...
        self.actionSaveSelectionToFile.triggered.connect(
            self.save_selection_to_file)
        self.actionLoadSelectionFromFile.triggered.connect(
            self.load_selection_from_file)
        self.actionLoadSelectionFromClipboard.triggered.connect(
            self.load_selection_from_clipboard)
        self.actionCopyFilenameToClipboard.triggered.connect(
            self.copy_filename_to_clipboard)
        self.actionCopyFilenameWithFullPath.triggered.connect(
            self.copy_filename_with_full_path)
        self.actionCopyAllShownColumns.triggered.connect(
            self.copy_all_shown_columns)
        self.actionCompareDirectories.triggered.connect(
        ...
        self.actionExecuteInternalCommand.triggered.connect(
        ...
        self.actionShowOccupiedSpace.triggered.connect(
            self.show_occupied_space)
        ...
        self.actionDisconnectNetworkDrive.triggered.connect(
            self.disconnect_network_drive)
        self.actionCopyNamesWithUNCPath.triggered.connect(
            self.copy_names_with_uncpath)

        self.actionNewTab.triggered.connect(self.new_tab)
        self.actionRenameTab.triggered.connect(self.rename_tab)
        self.actionOpenFolderInNewTab.triggered.connect(
            self.open_folder_in_new_tab)
        self.actionCloseTab.triggered.connect(self.close_tab)
        self.actionCloseDuplicateTabs.triggered.connect(
            self.close_duplicated_tab)

        self.actionNormal.triggered.connect(self.normal)
        self.actionLocked.triggered.connect(self.locked)
        self.actionLockedWithDirectoryChangesAllowed.triggered.connect(
            self.locked_with_directory_changes_allowed)
        self.actionLockedWithDirectoriesOpenedInNewTabs.triggered.connect(
            self.locked_with_directories_opened_in_new_tabs)
        self.actionSetAllTabsToNormal.triggered.connect(
            self.set_all_tabs_to_normal)
        self.actionSetAllTabsToLocked.triggered.connect(
            self.set_all_tabs_to_locked)
        self.actionAllTabsLockedWithDirChangesAllowed.triggered.connect(
            self.all_tabs_locked_with_dir_changes_allowed)
        self.actionAllTabsLockedWithDirOpenedInNewTabs.triggered.connect(
            self.all_tabs_locked_with_dir_opened_in_new_tabs)

        self.actionSwitchToNextTab.triggered.connect(self.switch_to_next_tab)
        self.actionSwitchToPreviousTab.triggered.connect(
        ...
        self.actionSaveCurrentTabsToNewFavoriteTabs.triggered.connect(
            self.save_current_tabs_to_new_favorite_tabs)
        self.actionLoadTabsFromFavoriteTabs.triggered.connect(
            self.load_tabs_from_favorite_tabs)

        self.actionConfigurationOfFolderTabs.triggered.connect(
            self.configuration_of_folder_tabs)
        self.actionConfigurationOfFavoriteTabs.triggered.connect(
            self.configuration_of_favorite_tabs)

        self.actionSaveCurrentTabsToNewFavoriteTabs.triggered.connect(
            self.save_current_tabs_to_new_favorite_tabs)
        self.actionResaveOnTheLastFavoriteTabsLoaded.triggered.connect(
            self.resave_on_the_last_favorite_tabs_loaded)
        self.actionRelopadTheLastFavoriteTabsLoaded.triggered.connect(
            self.relopad_the_last_favorite_tabs_loaded)
        self.actionConfigurationOfFavoriteTabs.triggered.connect(
            self.configuration_of_favorite_tabs)
        ...
        self.actionShowHiddenSystemFiles.triggered.connect(
            self.show_hidden_system_files)
        self.actionHorizontalPanelsMode.triggered.connect(
            self.horizontal_panels_mode)
        ...
        self.actionConfigurationOfDirectoryHotlist.triggered.connect(
            self.configuration_of_directory_hotlist)
        self.actionConfigurationOfFileAssociations.triggered.connect(
            self.configuration_of_file_associations)
        self.actionConfigurationOfArchivers.triggered.connect(
            self.configuration_of_archivers)
        ...
        self.actionVisitDoubleCommanderWebsite.triggered.connect(
            self.visit_double_commander_website)
