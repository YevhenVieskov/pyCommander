...
class ComboBoxDrives(QtWidgets.QWidget):
    def __init__(self, objectName = "comboBoxDrives",
                 parent = None): 
        super().__init__()
        self.objectName = objectName
        self.parent = parent
    ...
    def _initComboBoxDrives(self):    
        self.comboBoxDrives = QtWidgets.QComboBox(self.parent)
        ...
        for i in range(n):
            ...
            if(i == n1):
                iname = os.path.join(path, "drive-virtual.png")  
            text = "VFS"    
            self.comboBoxDrives.addItem(iname, "")
            self.comboBoxDrives.setItemText(i, text)
...
class DrivesList(QtWidgets.QWidget):
    ...
    def _initDrivesList(self):
        ...
        self.horizontalLayoutDrivesList.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        ...
        self.comboBoxDrives = ComboBoxDrives(self.parent)
        self.horizontalLayoutDrivesList.addWidget(self.comboBoxDrives)
        spacerItemDrives = QtWidgets.QSpacerItem(self.wspacer, self.hspacer, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayoutDrivesList.addItem(spacerItemDrives)
        
        self.pushButtonDirectoryHotlist = pushButtonDrives(objectName = "pushButtonDirectoryHotlist", text = "*",  parent = self.parent)
        self.horizontalLayoutDrivesList.addWidget(self.pushButtonDirectoryHotlist)
        self.pushButtonGotoRootDirectory = pushButtonDrives(objectName = "pushButtonGotoRootDirectory", text = "\\", parent = self.parent)
        self.horizontalLayoutDrivesList.addWidget(self.pushButtonGotoRootDirectory)
        self.pushButtonGotoParentDirectory = pushButtonDrives(objectName = "pushButtonGotoParentDirectory", text = "..", parent = self.parent)
        self.horizontalLayoutDrivesList.addWidget(self.pushButtonGotoParentDirectory)
        self.pushButtonGotoHomeDirectory = pushButtonDrives(objectName = "pushButtonGotoHomeDirectory", text = "~", parent = self.parent)
        self.horizontalLayoutDrivesList.addWidget(self.pushButtonGotoHomeDirectory)
        self.pushButtonRightLeftPanel = pushButtonDrives(objectName = "pushButtonGotoRightLeftPanel", text = "<", parent = self.parent)
